...
seq_root = data_root + 'MOT15/images/train'
label_root = data_root + 'MOT15/labels_with_ids/train'
...
for seq in seqs:  # 每段视频都对应一个gt.txt
    ...
    # seq_info = open(seq_info_path).read()  # 读取 *.ini 文件
    ...
    for fid, tid, x, y, w, h, mark, _, _, _ in gt:
        # frame_id, track_id, top, left, width, height, mark，
