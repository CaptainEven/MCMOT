...
if __name__ == "__main__":
    ...
    # result_dir = os.path.join("/users/duanyou/c5/results_v4all/results_all/")
    ...
    # image_list_file = os.path.join(data_path,"test.txt")
    # result_dir = os.path.join("/users/duanyou/c5/results_v4all/results_changsha/")
    # if not os.path.exists(result_dir):
    #     os.mkdir(result_dir)
    # batch_analysis(weights_list_file,image_list_file,0.20,0.45,result_dir)
    ...
    # image_list_file = os.path.join(data_path,"test.txt")
    # result_dir = os.path.join("/users/duanyou/c5/results_v4all/results_hezhoupucheng/")
    # if not os.path.exists(result_dir):
    #     os.mkdir(result_dir)
    # batch_analysis(weights_list_file,image_list_file,0.20,0.45,result_dir)
    ...
    # image_list_file = os.path.join(data_path,"test.txt")
    # result_dir = os.path.join("/users/duanyou/c5/results_v4all/results_puer/")
    # if not os.path.exists(result_dir):
    #     os.mkdir(result_dir)
    # batch_analysis(weights_list_file,image_list_file,0.20,0.45,result_dir)
    ...
    # image_list_file = os.path.join(data_path,"test.txt")
    # result_dir = os.path.join("/users/duanyou/c5/results_v4all/results_yancheng/")
    # if not os.path.exists(result_dir):
    #     os.mkdir(result_dir)
    # batch_analysis(weights_list_file,image_list_file,0.20,0.45,result_dir)
